...
namespace SiteForAdaptation.Migrations
{
    ...
    [Migration("20220425110824_qwer1")]
    partial class qwer1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiteForAdaptation.Data.Entities.MemoForManagerItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("MemoForManagerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MemoForManagerId");

                    b.ToTable("MemoForManagerItems");
                });
            ...
            modelBuilder.Entity("SiteForAdaptation.Data.Entities.MemoForManagerItem", b =>
                {
                    b.HasOne("SiteForAdaptation.Data.Entities.MemoForManager", null)
                        .WithMany("Items")
                        .HasForeignKey("MemoForManagerId");
                });
            ...
            modelBuilder.Entity("SiteForAdaptation.Data.Entities.UserTask", b =>
                {
                    b.HasOne("SiteForAdaptation.Data.Entities.Company", "Company")
                        .WithOne("UserTasks")
                        .HasForeignKey("SiteForAdaptation.Data.Entities.UserTask", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SiteForAdaptation.Data.Entities.UserType", "UserType")
                        .WithOne("UserTask")
                        .HasForeignKey("SiteForAdaptation.Data.Entities.UserTask", "UserTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
